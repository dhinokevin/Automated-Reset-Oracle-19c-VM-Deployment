...
The project uses Git for version control. To clone the repository and start working with the project, run the following command:
...
- **SQL**: For interaction with Oracle Database via SQL scripts.
